...
{
    [TestFixture]
    public class TestLoginForCustomer
    {
       ...
       /* private Token _token;
        ...
        public async Task Login_ValidCredentials_ReturnsExpectedValue(LoginTestData login)
        {
            ...
            // Act
            IActionResult actionResult = await _controller.LoginForCustomer(loginDTO);
        ...
        private static IEnumerable<LoginTestData> TestDataFromCSV
        {
            get
            {
                string csvFilePath = (@"C:\Users\Admin\source\repos\SWP391Poject\TestUserCase\TestData\dataTestLoginForCustomer.csv");
