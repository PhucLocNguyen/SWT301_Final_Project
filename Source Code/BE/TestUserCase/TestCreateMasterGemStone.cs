...
{
    [TestFixture]
    public class TestCreateMasterGemStone
    {
        ...
        private static IEnumerable<CreateMasterGemStoneTest> TestDataFromCSV
        {
            get
            {
                string csvFilePath = (@"C:\Users\Admin\source\repos\SWP391Poject\TestUserCase\TestData\dataTestCreateMasterGemStone.csv");
        ...
        public async Task Create_ValidCredentials_ReturnsExpectedValue(CreateMasterGemStoneTest createMasterGemStoneTest)
        {
            ...
            // Act
            IActionResult actionResult = _controller.CreateMasterGemstone(requestCreateMasterGemstone);
